...
\begin{frame}{Qual é o método?}
    ...
    \begin{tikzpicture}[node distance = 2cm, scale=0.9]
        ...
        \node[draw=none] at (3.20, -4.25) (no) {Não};
    ...
    \begin{equation*}
        \left\{
            \begin{array}{l}
                ...
                \textcolor{teal}{u'(a) = (q(a) - \lambda r(a))/p'(a)} \text{ (lema técnico)}
            \end{array}
        \right.
    \end{equation*}
    %
...
\begin{frame}{}
    ...
    \vfill
    \usebeamerfont{title} \href{https://github.com/CaioTomas/Trabalho-final-IMCEDO}{Códigos}
\end{frame}
%
\end{document}